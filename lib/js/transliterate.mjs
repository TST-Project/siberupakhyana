    ...
    */
    ...
    const transliterator = {
        ...
        convertNums() {
            ...
            const newWalker = (num) => document.createTreeWalker(num,NodeFilter.SHOW_TEXT,
                {acceptNode: () => NodeFilter.FILTER_ACCEPT });
            for(const num of nums) {
                const walker = newWalker(num);
                var curnode = walker.currentNode;
